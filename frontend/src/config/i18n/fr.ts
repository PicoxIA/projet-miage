export const fr = {
  ...
  enrichingWait: "L'IA analyse le compte rendu, veuillez patienter…",
  enrichError: "Erreur lors de l'enrichissement IA.",
  enrichErrorBackend: "Le serveur n'a pas pu enrichir le texte. Vérifiez que Flask et Ollama sont actifs (ollama serve).",
  enrichErrorNetwork: "Impossible de joindre le serveur. Vérifiez que le backend est lancé sur le port 5000.",
  enrichErrorTimeout: "L'IA met trop de temps à répondre. Vérifiez Ollama ou réessayez avec un texte plus court.",
